...
import BottomHomePage from "@/components/landing/sections/BottomHomePage";
import Clients from "@/components/landing/sections/Clients";
import HomePageHero from "@/components/landing/sections/HomePageHero";
...
function page() {
	return (
		<>
			...
			<div
				className={cn(
					"mask-radial-faded pointer-events-none relative z-[-1] mt-[-12.8rem] mb-[-26.8rem] h-[60rem] overflow-hidden",
					"[--color:#ff7000] before:absolute before:inset-0 before:bg-radial-faded before:opacity-[0.4]",
					"after:absolute after:top-1/2 after:-left-1/2 after:h-[142.8%] after:w-[200%] after:rounded-[50%] after:border-t after:border-[rgba(120,_119,_198,_0.4)] after:background-light850_dark100 z-5"
				)}
			>
				<svg
			...
			{/* <div
				className={cn(
					"mask-radial-faded pointer-events-none relative mt-[-35.8rem] mb-[-36.8rem] h-[90rem] overflow-hidden",
					"[--color:#ff7000] before:absolute before:inset-0 before:bg-radial-faded before:opacity-[0.4]",
					"after:absolute after:bottom-1/2 after:-left-1/2 after:h-[142.8%] after:w-[200%] after:rounded-[50%] after:border-t after:border-[rgba(120,_119,_198,_0.4)] after:background-light850_dark100 z-5"
				)}
			>
				<svg
					xmlns="http://www.w3.org/2000/svg"
			...
			<div
				className={cn(
					"mask-radial-faded pointer-events-none relative z-[-1] mt-[-15.8rem] mb-[-26.8rem] h-[60rem] overflow-hidden",
					"[--color:#ff7000] before:absolute before:inset-0 before:bg-radial-faded before:opacity-[0.4]",
					"after:absolute after:bottom-1/2 after:-left-1/2 after:h-[142.8%] after:w-[200%] after:rounded-[50%] after:border-t after:border-[rgba(120,_119,_198,_0.4)] after:background-light850_dark100 z-5"
				)}
			>
