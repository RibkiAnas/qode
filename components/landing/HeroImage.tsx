...
function HeroImage() {
	...
	return (
		<div ref={ref} className="mt-[12.8rem] [perspective:2000px]">
			<div
				className={cn(
					"relative z-50 rounded-lg border border-transparent-white bg-white bg-opacity-[0.01] bg-hero-gradient",
			...
			>
				...
				<img
					className={cn(
						"relative rounded-lg z-10 transition-opacity object-contain delay-[680ms]",
